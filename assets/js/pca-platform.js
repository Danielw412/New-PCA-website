const FEATURE_ROUTES = [
	{
		...
		load: () => import("./modules/accounts.js?v=20260911-ui-polish-v1"),
	},
	{
		key: "registration",
		selector: "[data-platform-registration], [data-volunteer-request-page]",
		load: () => import("./modules/events-registration.js?v=20260911-ui-polish-v1"),
	},
	{
		key: "blog",
		selector: "[data-blog-feed], [data-blog-post], [data-blog-editor]",
		load: () => import("./modules/blog.js?v=20260911-ui-polish-v1"),
	},
	{
		key: "administration",
		selector: "[data-platform-admin]",
		load: () => import("./modules/administration.js?v=20260911-ui-polish-v1"),
	},
	{
		key: "council",
		selector: "[data-council-roster], [data-platform-admin]",
		load: () => import("./modules/council.js?v=20260911-ui-polish-v1"),
	},
];
